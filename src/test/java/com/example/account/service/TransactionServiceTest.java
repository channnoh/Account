...
import static com.example.account.type.TransactionType.CALCEL;
...
class TransactionServiceTest {
    ...
    public static final long USE_AMOUNT = 2000L;
    ...
    void successCancelBalance() {
        ...
        assertEquals(S, transactionDto.getTransactionResultType());
        assertEquals(CALCEL, transactionDto.getTransactionType());
